...
<div class="stat-card mb-3">
    <form method="GET" class="row g-2">
        ...
        <div class="col-md-2">
            <a href="?route=moderator/foodItems" class="btn btn-outline-secondary w-100">
                ...
                <?php else: ?>
                    <?php foreach ($foodItems as $item): ?>
                        <tr>
                            ...
                            <td>
                                <a href="?route=moderator/foodItemsEdit&id=<?php echo $item['id']; ?>" class="btn btn-sm btn-outline-primary me-1">
                                    <i class="fas fa-edit"></i> Sửa
                                </a>
                                <a href="?route=moderator/foodItemsDelete&id=<?php echo $item['id']; ?>" 
